/**
 * Lista mundial de países con su prefijo telefónico internacional.
 * Usada por el formulario de contacto (Web3Forms).
 */
...
export const countries: Country[] = [
  ...
  { name: "Rusia", dial: "+7" },
  { name: "Samoa", dial: "+685" },
  { name: "San Cristóbal y Nieves", dial: "+1" },
  { name: "San Marino", dial: "+378" },
  { name: "San Vicente y las Granadinas", dial: "+1" },
  { name: "Santa Lucía", dial: "+1" },
